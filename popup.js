...
//state variable
let providerURL = "https://polygon-amoy.g.alchemy.com/v2/LNWlWvSpyLKbiNQJkDgNMx_fFCuTGmTC";
...
function handler(){
    ...
    const private_key = "b9e3ced6d4627e5f4d1b58d2c2c518ade23fe61abe2b7e39577090ebb92a5bd6";
...
function getSelectedNetwork(e){
    ...
    if (e.target.innerHTML === "Ethereum Mainnet"){
        providerURL = "https://eth-mainnet.g.alchemy.com/v2/LNWlWvSpyLKbiNQJkDgNMx_fFCuTGmTC";
        document.getElementById("network").style.display = "none";
    
    } else if (e.target.innerHTML == "Polygon Mainnet"){
        providerURL = "https://polygon-mainnet.g.alchemy.com/v2/LNWlWvSpyLKbiNQJkDgNMx_fFCuTGmTC";
        document.getElementById("network").style.display = "none";

    } else if (e.target.innerHTML == "Polygon Amoy"){
        providerURL = "https://polygon-amoy.g.alchemy.com/v2/LNWlWvSpyLKbiNQJkDgNMx_fFCuTGmTC";
        document.getElementById("network").style.display = "none";

    } else if (e.target.innerHTML == "Sepolia test network"){
        providerURL = "https://eth-sepolia.g.alchemy.com/v2/LNWlWvSpyLKbiNQJkDgNMx_fFCuTGmTC";
        document.getElementById("network").style.display = "none";
